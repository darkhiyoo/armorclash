    ...
    createDebugUI() {
        ...
        debugPanel.innerHTML = `
            ...
            <div style="margin-top: 5px;">
                <label><input type="checkbox" id="toggleCoords" checked> Coordinates</label><br>
                <label><input type="checkbox" id="toggleEntities" checked> Entity Positions</label><br>
