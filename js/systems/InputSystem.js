class InputSystem {
    constructor(gamepadManager) {
        ...
        // Input mappings for keyboard - comprehensive key support
        this.keyMappings = {
            // Player 1 (Arrow keys + WASD + alternatives)
            0: {
            ...
            // Player 2 (Alternative keys)
            1: {
                up: ['KeyT', 'KeyY', 'KeyU', 'KeyO'],
                down: ['KeyG', 'KeyH', 'KeyN', 'Period'],
                left: ['KeyR', 'KeyE', 'KeyQ', 'Comma'],
                right: ['KeyY', 'KeyU', 'KeyI', 'Slash'],
                fire: ['KeyQ', 'KeyE', 'KeyR', 'KeyT', 'Tab', 'ShiftLeft', 'ShiftRight'],
                pause: ['Enter', 'Backspace']
            }
        };
    ...
    updatePlayerInput(player) {
        ...
        // Touch controls (only for player 1)
        if (playerIndex === 0) {
    ...
    getGamepadInput(playerIndex) {
        ...
        // D-pad input
        const dpad = this.gamepadManager.getDPad(playerIndex);
        ...
        // Left stick input
        const leftStick = this.gamepadManager.getLeftStick(playerIndex);
        ...
        // Button input
        controls.fire = this.gamepadManager.isButtonPressed(playerIndex, 'A') ||
                       this.gamepadManager.isButtonPressed(playerIndex, 'X') ||
                       this.gamepadManager.isButtonPressed(playerIndex, 'RB');
